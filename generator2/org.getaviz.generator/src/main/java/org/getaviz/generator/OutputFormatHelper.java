...
public class OutputFormatHelper {
	...
	public static String AFrameHead() {
		...
		builder.append("\n");
		builder.append("\t    <title>ACity</title>");
		builder.append("\n");
		builder.append("\t    <meta name=\"description\" content=\"Getaviz\">");
		builder.append("\n");
		builder.append("\t    <script src=\"https://aframe.io/releases/1.0.2/aframe.min.js\"></script>");
		builder.append("\n");
		builder.append("\t </head>");
		builder.append("\n");
		builder.append("\t <body>");
		...
		builder.append("\n");
		builder.append("\t\t\t <a-camera position=\"-10 10 0\"></a-camera>");
		builder.append("\n");
